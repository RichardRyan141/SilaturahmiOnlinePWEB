...
$user_id_query = "SELECT id FROM pejabat WHERE username = '$current_user'";
$result = mysqli_query($db, $user_id_query);
$user_id = mysqli_fetch_assoc($result)['id'];

$sql = "SELECT * FROM pesan WHERE id_pejabat = '$user_id' AND jenis_pesan = 'Ucapan Hari Raya'";
    ...
    <main>
        <?php
            ...
            foreach ($messages as $message) {
                ...
                echo "<a href='buat-balasan.php?id={$message['id']}'>Reply</a>";
                echo "</ul>";
                echo "</div>";
            }
        ?>
